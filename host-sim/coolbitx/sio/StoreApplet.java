...
public class StoreApplet extends Applet implements AppletEvent {
	...
	public Shareable getShareableInterfaceObject(AID clientAID, byte parameter) {
		if (clientAID == null) {
			System.out.println("DEBUG: [SHADOW] clientAID is null.");
		} else {
			byte[] aidBytes = new byte[16];
			byte len = clientAID.getBytes(aidBytes, (short) 0);
			System.out.println("DEBUG: [SHADOW] clientAID=" + Hex.toHexString(aidBytes, (short) 0, len));
		}
		System.out.println("DEBUG: [SHADOW] Bypassing clientAID check for simulator.");
